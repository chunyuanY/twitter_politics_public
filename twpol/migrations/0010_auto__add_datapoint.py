...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'twpol_datapoint', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'twpol', ['DataPoint'])

        # Adding index on 'Candidate', fields ['twitter_id']
        db.create_index(u'twpol_candidate', ['twitter_id'])

        # Adding index on 'Voter', fields ['twitter_id']
        db.create_index(u'twpol_voter', ['twitter_id'])


    def backwards(self, orm):
        # Removing index on 'Voter', fields ['twitter_id']
        db.delete_index(u'twpol_voter', ['twitter_id'])

        # Removing index on 'Candidate', fields ['twitter_id']
        db.delete_index(u'twpol_candidate', ['twitter_id'])

        # Deleting model 'DataPoint'
        db.delete_table(u'twpol_datapoint')
    ...
    models = {
        u'twpol.candidate': {
            ...
            'twitter_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'}),
