...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.followee_error_code'
        db.add_column(u'twpol_voter', 'followee_error_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.followee_error_code'
        db.delete_column(u'twpol_voter', 'followee_error_code')
    ...
    models = {
        ...
        u'twpol.voter': {
            ...
            'followee_error_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3'}),
