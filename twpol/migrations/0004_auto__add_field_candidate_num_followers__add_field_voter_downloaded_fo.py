...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.num_followers'
        db.add_column(u'twpol_candidate', 'num_followers',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Voter.downloaded_followers'
        db.add_column(u'twpol_voter', 'downloaded_followers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.num_followers'
        db.delete_column(u'twpol_candidate', 'num_followers')

        # Deleting field 'Voter.downloaded_followers'
        db.delete_column(u'twpol_voter', 'downloaded_followers')
