...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Candidate', fields ['twitter_id']
        db.create_unique(u'twpol_candidate', ['twitter_id'])

        # Adding unique constraint on 'Voter', fields ['twitter_id']
        db.create_unique(u'twpol_voter', ['twitter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Voter', fields ['twitter_id']
        db.delete_unique(u'twpol_voter', ['twitter_id'])

        # Removing unique constraint on 'Candidate', fields ['twitter_id']
        db.delete_unique(u'twpol_candidate', ['twitter_id'])
