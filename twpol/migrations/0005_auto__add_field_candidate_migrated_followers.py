...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.migrated_followers'
        db.add_column(u'twpol_candidate', 'migrated_followers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.migrated_followers'
        db.delete_column(u'twpol_candidate', 'migrated_followers')
