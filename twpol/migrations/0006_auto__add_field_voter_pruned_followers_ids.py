...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.pruned_followers_ids'
        db.add_column(u'twpol_voter', 'pruned_followers_ids',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.pruned_followers_ids'
        db.delete_column(u'twpol_voter', 'pruned_followers_ids')
