...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.num_follower_attempts'
        db.add_column(u'twpol_voter', 'num_follower_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Voter.num_followee_attempts'
        db.add_column(u'twpol_voter', 'num_followee_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.num_follower_attempts'
        db.delete_column(u'twpol_voter', 'num_follower_attempts')

        # Deleting field 'Voter.num_followee_attempts'
        db.delete_column(u'twpol_voter', 'num_followee_attempts')
