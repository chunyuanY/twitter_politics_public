...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.should_process'
        db.add_column(u'twpol_voter', 'should_process',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.should_process'
        db.delete_column(u'twpol_voter', 'should_process')
